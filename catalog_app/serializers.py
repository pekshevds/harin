...
class GoodSerializer(serializers.Serializer):
    ...
    code = serializers.CharField(max_length=11, required=False, allow_blank=True)
    okei = serializers.CharField(max_length=50, required=False, allow_blank=True)
    ...
    weight = serializers.DecimalField(max_digits=15, decimal_places=3, required=False)
    length = serializers.DecimalField(max_digits=15, decimal_places=3, required=False)
    width = serializers.DecimalField(max_digits=15, decimal_places=3, required=False)
    height = serializers.DecimalField(max_digits=15, decimal_places=3, required=False)
    ...
    def create(self, validated_data):
        ...
        good.okei = validated_data.get("okei", good.okei)
        ...
        good.weight = validated_data.get("weight", good.weight)
        good.length = validated_data.get("length", good.length)
        good.width = validated_data.get("width", good.width)
        good.height = validated_data.get("height", good.height)
